...
export const CreateCategory = () => {
    ...
    const uploadPhoto = async (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (files) {
            ...
            mutationUpload.mutate(formData, {
                onSuccess: (data) => {
                    setCategory((prev) => ({ ...prev, photos: [...prev.photos, ...data.data.results] }));
    ...
    return (
        <div className="flex flex-col h-full gap-10 px-4 pt-12">
            {mutationCreate.isLoading || mutationUpload.isLoading ? <component.Loading /> : null}
            <component.Breadcrumb page="categories" sub="create" />
